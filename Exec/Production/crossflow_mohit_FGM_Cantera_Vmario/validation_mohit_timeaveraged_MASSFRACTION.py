...
df_ref.columns = ['MassFraction', 'x_D']
...
plt.plot(df_ref['MassFraction'], df_ref['x_D'], 
...
# Formatting
plt.xlabel('Mass Fraction [CH4]', fontsize=12)
...
plt.tight_layout()
plt.savefig('mohit_fig4aY.png', dpi=300)
plt.show()
###################################################################################################
#
######################## PLOT 6D ##############################################################
